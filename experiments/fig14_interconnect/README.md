# fig14_interconnect — Fig. 14: via-host vs inter-bank sharing (R8)
...
{UPMEM, HBM-PIM} (spaces a b; shared with the Fig 9 pool) -> the figure's
...
warm); full `<1 min` with the fig09 pool present measured (evaluation + render
